    ...
    return (
     ...
     <section id="hero-section" className="min-h-screen">
      <div className="group/hero relative w-full flex justify-center items-start">
        <div
          className="absolute top-1/4 w-[60%] h-[450px] rounded-full bg-[radial-gradient(circle,rgba(255,255,0,0.2)_0%,rgba(255,255,0,0)_90%)] group-hover/hero:bg-[radial-gradient(circle,rgba(255,255,0,0.3)_0%,rgba(255,255,0,0)_90%)] transition-all duration-500 -translate-x-1/4 z-[-1] blur-xl"
        ></div>
        <div className="max-w-screen-xl w-full bg-white/10 backdrop-blur-lg">
          <div className="grid grid-cols-1 px-4 pt-16 pb-8 gap-8">
            ...
            <p className="w-1/2 text-lg font-medium text-neutral-800">
          ...
          <div>
            <div
              className="flex flex-col sm:flex-row py-10 ps-24 space-y-4 sm:space-y-0 space-y-reverse space-x-reverse sm:-space-x-1 xl:-space-x-20 mx-8 sm:mx-0"
            >
              <div
                className="relative flex justify-between z-20 hover:z-30 hover:scale-110 hover:rotate-0 transition-all duration-300 w-full -left-40 px-6 py-6 md:w-[380px] bg-white rounded-2xl shadow-xl -rotate-[6deg] border border-gray-100"
              >
                ...
                <div className="relative w-1/3 -left-2 -bottom-4 bg-white h-full">
                  ...
                  />
                  <div
                    className="absolute left-1/2 -translate-x-1/2 w-16 h-1 bg-[radial-gradient(circle,rgba(0,0,0,0.1)_0%,rgba(200,200,200,0.1)_90%)] rounded-full bottom-1"
                  ></div>
                </div>
              </div>
              <div
                className="relative z-10 hover:z-30 hover:scale-110 hover:animate-fadeInOut animate-fadeOutIn hover:rotate-0 transition-all duration-300 w-full -left-32 px-6 py-6 md:w-[338px] bg-gradient-to-l from-yellow-300 to-yellow-100 rounded-2xl shadow-xl -rotate-[20deg] overflow-hidden"
              >
              ...
              <div
                className="relative flex justify-between z-0 hover:z-30 hover:animate-fadeInOut animate-fadeOutIn hover:scale-110 hover:rotate-0 transition-all duration-300 w-full -left-32 px-6 py-6 md:w-[346px] bg-white rounded-2xl shadow-xl -rotate-[32deg] overflow-hidden"
              >
                <div className="flex flex-col h-full gap-8">
                  <div className="px-4">
