          ...
          <div className="grid grid-cols-2 gap-4 py-6">
            <div>
              <input
                ...
                onChange={e =>
                  setData(prevState => ({
                    ...prevState,
                    comment_full_name: e.target.value,
                  }))
                }
            ...
            <div>
              <input
                ...
                onChange={e =>
                  setData(prevState => ({
                    ...prevState,
                    comment_subject: e.target.value,
                  }))
                }
                className="bg-gray-50 text-gray-600 outline-none border-2 border-gray-200 focus:border-gray-500 transition-all duration-200 placeholder:text-grounded-lgy-400 placeholder:text-sm placeholder:font-normal text-sm font-normal w-full px-3 py-3 rounded-md"
              />
            ...
            <div className="col-span-2 justify-self-end">
              <button
                ...
                } bg-stone-800 text-white  ring-2 ring-transparent focus:outline-none hover:opacity-40 focus:!ring-stone-400 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2`}
              >
                <svg
                  aria-hidden="true"
                  role="status"
                ...
                <span className={`${isLoading ? 'inline' : 'hidden'}`}>
                  {' '}
                  در حال ارسال دیدگاه{' '}
                </span>
              </button>
