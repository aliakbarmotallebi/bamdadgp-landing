export default function Fab() {
  return (
    <ol className="flex flex-col gap-4 z-30 fixed bottom-4 right-4">
      <li className="bg-white size-12 rounded-full border border-gray-300 hover:border-gray-800 cursor-pointer">
        <a
          href="https://www.instagram.com/bamdadgp"
          className="block w-full h-full p-3.5"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      <li className="bg-white size-12 rounded-full border border-gray-300 hover:border-gray-800 cursor-pointer">
        <a href="tel:02166429535" className="block w-full h-full p-3.5">
          <svg
            fill="#000000"
            viewBox="0 0 32 32"
            version="1.1"
