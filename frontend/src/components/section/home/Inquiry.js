      ...
      <div className="relative mx-auto max-w-7xl my-16">
              ...
              <div className="flex items-center flex-col gap-6 w-full">
                <div className="py-2 max-w-5xl mx-auto">
                  <p className="text-base my-2 text-center lg:text-xl text-stone-700 leading-relaxed">
                    با استفاده از این بخش می‌توانید گارانتی کالای خود را
                    به‌راحتی استعلام کرده و فعال‌سازی آن را انجام دهید. تنها
                    کافیست فرم زیر را تکمیل نمایید تا اطلاعات دقیق و تاریخ
                    فعالسازی برای شما نمایش داده شود.
                  </p>
                </div>
        ...
        focus:border-gray-500 transition-all"
                ...
                >
                  {loading ? (
                    <svg
                      className="size-5 animate-spin text-stone-800"
