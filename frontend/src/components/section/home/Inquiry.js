  ...
  return (
    ...
    <div
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4 w-full">
        <input type="text" placeholder="نام و نام خانوادگی" value={fullName} onChange={e=> setFullName(e.target.value)}
        className="w-64 outline-none rounded-md px-3 py-2 bg-white border-2 text-stone-800 border-gray-200
        focus:border-gray-500 transition-all"
        />
        <input type="text" placeholder="شماره موبایل" value={phoneNumber} onChange={e=> setPhoneNumber(e.target.value)}
        className="w-64 outline-none rounded-md px-3 py-2 bg-white border-2 text-stone-800 border-gray-200
        focus:border-gray-500 transition-all"
        />
        <input type="text" placeholder="شماره گارانتی" value={serialNumber} onChange={e=>
        setSerialNumber(e.target.value)}
        className="w-64 outline-none rounded-md px-3 py-2 bg-white border-2 text-stone-800 border-gray-200
        focus:border-gray-500 transition-all"
        />
        <button onClick={onActivation} disabled={loading}
          ...
          {loading ? (
          <svg className="size-5 animate-spin text-stone-800" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 24 24">
    ...
    <div className="bg-white p-6 rounded-3xl border-2 border-[#5f5d5a20] ">
      ...
      <div
        className="relative grid grid-cols-1 md:grid-cols-2 place-items-center gap-4 md:gap-0 lg:flex lg:justify-center">
        <div className="size-72 border-t-4 border-yellow-400/60 border-dotted rounded-full text-center relative">
          <div className="p-8 relative text-center">
            ...
            <span className="size-12 xl:size-16 my-4 inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" className="text-[#cc8e3550] size-full" viewBox="0 0 512 512">
        ...
        <div className="size-72 border-b-4 border-yellow-400/60 border-dotted rounded-full text-center relative">
          <div className="p-8 relative text-center">
            ...
            <span className="size-12 xl:size-16 my-4 inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-full text-[#cc8e3550]" viewBox="0 0 24 24">
        ...
        <div className="size-72 border-t-4 border-yellow-400/60 border-dotted rounded-full text-center relative">
          <div className="p-8 relative text-center">
            ...
            <span className="size-12 xl:size-16 my-4 inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" className="text-[#cc8e3550]" viewBox="0 0 16 16">
        ...
        <div className="size-72 border-b-4 border-yellow-400/60 border-dotted rounded-full text-center relative">
          <div className="p-8 relative text-center">
            ...
            <span className="size-12 xl:size-16 my-4 inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" className="text-[#cc8e3550]" viewBox="0 0 24 24">
                <rect width="24" height="24" fill="none" />
                <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
