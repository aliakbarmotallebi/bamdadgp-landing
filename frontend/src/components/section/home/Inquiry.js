export default function Inquiry(){
    return (
              ...
              <section id="warranty-inquiry" className="services-section scroll-mt-28">
                <div className="relative mx-auto max-w-7xl my-16">
                  <div
                    className="absolute left-1/4 top-1/3 w-[800px] h-[550px] rounded-full bg-[radial-gradient(circle,rgba(255,255,0,0.20)_0%,rgba(255,255,0,0)_90%)] -translate-x-1/2 z-[-1] blur-xl"
                  ></div>
                  <div
                    className="relative flex flex-col items-start p-16 mb-4 bg-white border border-gray-200 overflow-hidden rounded-3xl shadow-sm"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="opacity-40 w-48 h-48 absolute z-0 -top-10"
                      viewBox="0 0 20 20"
                    >
                      <g fill="none">
                        <path
                    ...
                    <div
                      className="relative flex justify-start items-center flex-col gap-2"
                    >
                      <div className="absolute -top-12 w-32 h-20 -left-32 rotate-90">
                        <svg
                          fill="#fde047"
                          width="100%"
                          height="100%"
                      ...
                      <div className="w-full flex items-center gap-4">
                        ...
                        <button
                          className="bg-yellow-300 hover:bg-[#bg-yellow-300] transition-all duration-200 hover:text-white hover:bg-yellow-500 text-stone-800 py-2.5 px-3.5 rounded-md"
                        >
                  ...
                  <div
                    className="bg-white flex items-center px-12 py-6 rounded-3xl border-2 border-[#cc8e3520]"
                  >
