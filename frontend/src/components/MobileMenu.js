    ...
    <>
      ...
      >
        <button
          ...
          className="size-10 bg-stone-600 group right-0 top-0 rounded-bl-md flex absolute"
        >
          <span className="size-full p-1 pr-0 text-yellow-400 group-hover:text-yellow-600 transition-all duration-200">
            <svg
