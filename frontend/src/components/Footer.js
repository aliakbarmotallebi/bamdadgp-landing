    ...
    return(
        ...
        <div className="w-full max-w-screen-xl mx-auto p-4 pt-10 pb-0 grid grid-cols-7">
          ...
          <div className="flex flex-col pt-1 pe-12 col-span-2">
            <div>
              <h2 className="font-bold text-lg text-neutral-950">با ما در تماس باشید</h2>
              ...
              <ul className="mt-4 flex flex-col gap-8">
                <li className="flex items-center">
                  ...
                  <p className="ps-4">
                    تهران - خیابان جمهوری - مابین خیابان فلسطین و ولیعصر - روبروی بانک
                    سپه - پلاک 962 مرکز خدمات بامداد سرویس (فروشگاه کوشا)
                  </p>
                </li>
        ...
        <div className="border-t border-[#888e3520]">
          <div
            className="w-full max-w-screen-xl mx-auto p-4 flex justify-between items-center"
          >
            <div>
              <a
